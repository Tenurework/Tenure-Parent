...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@tenure/configuration", "@tenure/blueprints", "@tenure/organization-model", "@tenure/module-runtime", "@tenure/modules", "@tenure/authorization", "@tenure/releases", "@tenure/workflow", "@tenure/audit"],

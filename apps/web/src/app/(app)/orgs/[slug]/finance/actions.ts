...
async function requireFinanceManager(userId: string, slug: string, action: string) {
...
export async function upsertBudgetLine(slug: string, formData: FormData) {
  ...
  await withTenantScope(userId, async () => {
    const org = await requireFinanceManager(userId, slug, "Finance.EditLine")
...
export async function deleteBudgetLine(slug: string, formData: FormData) {
  const userId = await requireUserId()
  await withTenantScope(userId, async () => {
    const org = await requireFinanceManager(userId, slug, "Finance.DeleteLine")
...
export async function saveForecast(slug: string, formData: FormData) {
  const userId = await requireUserId()
  await withTenantScope(userId, async () => {
    const org = await requireFinanceManager(userId, slug, "Finance.SaveForecast")
...
export async function importBudget(
  ...
  const userId = await requireUserId()
  await withTenantScope(userId, async () => {
    const org = await requireFinanceManager(userId, slug, "Finance.Import")
...
export async function postLedgerEntry(slug: string, formData: FormData) {
  const userId = await requireUserId()
  await withTenantScope(userId, async () => {
    const org = await requireFinanceManager(userId, slug, "Finance.PostLedger")
...
export async function deleteLedgerEntry(slug: string, formData: FormData) {
  const userId = await requireUserId()
  await withTenantScope(userId, async () => {
    const org = await requireFinanceManager(userId, slug, "Finance.DeleteLedger")
    const id = String(formData.get("id") ?? "")

...
- [x] GE-022-002 — Establish design tokens/components for dense ERP states: loading, empty, error, permission denied, stale, conflict, offline, archived, partial, and high-risk confirmation.

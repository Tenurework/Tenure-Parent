...
**23 modules in the plane · 2 owning domain(s) · 52 models in the schema · 2 of them owned by the plane · 3 write(s) from inside the plane · 0 violation(s).**
...
- **Ownership is derived, not declared here.** 23 plane modules, 0 of them owned by no domain.

...
**485 files · 13 domains with code · 1 declared and unbuilt · 21 shared.**
...
| `identity` | 70 | Who someone is: providers, sessions, the sign-in surface. |
| `authorization` | 19 | What someone may do: capabilities, policy decisions, delegation. |
| `organization` | 37 | The org graph: institutions, organizations, roles, seats, the directory. |

output "studio_url" {
  ...
  # The public origin, not the distribution hostname: the deploy workflow reads
  # this to prove the console serves, and once the custom domain is attached the
  # CloudFront name is no longer where an operator goes.
